...
const reflections = [
    ...
    `In Shane Hawk’s speech, Shane tells his own story of how he became a successful English teacher and author. One important theme I acknowledged was his motivation and resilience in his life. He explained certain events such as surviving COVID, finding an audience, and failing college in order to demonstrate he overcame incredibly difficult challenges in life. I believe that Shane Hawk has developed incredible emotional strength and perseverance because that is the reason why he was able to talk to us today. His experiences demonstrate that if you put in your utmost effort, you can get through anything. Additionally, the overall message Shane Hawk provides through his speech deeply connects to this course because in books such as The Marrow Thieves or Hunting By Stars, they similarly exemplify strong resilience and motivation by certain characters. Shane Hawk is a real life example of the powerful characters within the course texts.
...
const reflections2 = [
  ...
  `After reading this, I thought about how this is a hidden allegory and symbol towards the way the Canadian government treated the Indigenous peoples. The Canadian government tortured, killed, and held the Indigenous peoples by putting them in residential schools. This is indirectly portrayed by the totem pole being cut down and covered in pruning paste for reducing growth. The allegories and symbols challenged my thinking as it opened my mind to understand a new view or opinion of the story.
...
const reflections3 = [
  ...
  `After getting cut down numerous times already, the totem pole became a bigger annoyance by
  `,

  `To overcome this, he worked hard to reach out to bigger authors and ultimately got his book widely spread. Both of these flashbacks exemplify the resilience he has because he maintains a positive outlook and takes in the failures to adapt for success. As he puts it,
  `,
